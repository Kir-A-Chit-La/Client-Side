...
public class UITweener : MonoBehaviour
{
    ...
    private void SwapValues()
    {
        ...
        else if(_animationType == AnimationType.Move || _animationType == AnimationType.MoveLocal || _animationType == AnimationType.Rotate || _animationType == AnimationType.RotateLocal || _animationType == AnimationType.Scale)
        {
