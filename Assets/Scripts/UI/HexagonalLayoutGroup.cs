...
namespace UnityEngine.UI
{
    ...
    public class HexagonalLayoutGroup : LayoutGroup
    {
        ...
        protected HexagonalLayoutGroup() {}
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            for (int i = 0; i < rectChildren.Count; i++)
            {
                ...
                if(m_offsetHorizontal)
                {
                    ...
                    // Set Y position
                    if(positionX_offset < cellsPerMainAxis)
                        SetChildAlongAxis(rectChildren[i], 1, startOffset.y + (cellSize[1] + spacing[1]) * positionY_offset, cellSize[1]); // Lies on Row 1 of Subset
                    else
                        SetChildAlongAxis(rectChildren[i], 1, startOffset.y + (cellSize[1] + spacing[1]) * positionY_offset + cellSize[1] + spacing[1], cellSize[1]); // Lies on Row 2 of Subset
                }
                else
                {
